...
const ItemCS = () => {
    ...
    return <Table dataSource={dataSource} columns={columns} style={{ marginTop: 100, marginLeft: 100 }} />
}
...
const Home = () => {
    ...
    const menu = (
        ...
        >
            ...
            <Menu.Item key="5" onClick={()=> changeTarget('DKed')} icon={<ContainerOutlined />}>
                Thông tin các lớp đã đăng ký
            </Menu.Item>
            <Menu.Item key="30" onClick={() => changeTarget('DK')} icon={<ContainerOutlined />}>
                Đăng ký đào tạo
            </Menu.Item>
            ...
            contentDisplay = (
                <div style={{ display: 'flex' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', marginTop: 50 }}>
                        ...
                        <img
                            src='https://i.ytimg.com/vi/ckTK16tYC9k/maxresdefault.jpg'
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', marginTop: 150, marginLeft: 100 }}>
                        <span style={{ fontSize: 25, fontFamily: '-moz-initial' }}>Chức vụ: Nhân viên</span>
                        <span style={{ fontSize: 25, fontFamily: '-moz-initial' }}>Họ và tên: Nguyễn Văn A</span>
                        ...
                        <span style={{ fontSize: 25, fontFamily: '-moz-initial' }}>Đơn vị công tác: Phòng A</span>
                    </div>
                </div>
            )
            break;
